...
static inline void assign_vec3(const vec3 *u, vec3 *v)
{
	(*v)[0] = (*u)[0];
	(*v)[1] = (*u)[1];
	(*v)[2] = (*u)[2];
...
static inline void assign_vec4(const vec4 *u, vec4 *v)
{
	(*v)[0] = (*u)[0];
	(*v)[1] = (*u)[1];
	(*v)[2] = (*u)[2];
...
static inline void assign_mat3(const mat3 *m, mat3 *n)
{
	(*n)[0] = (*m)[0];
	(*n)[1] = (*m)[1];
	(*n)[2] = (*m)[2];
...
static inline void assign_mat4(const mat4 *m, mat4 *n)
{
	(*n)[0] = (*m)[0];
	(*n)[1] = (*m)[1];
	(*n)[2] = (*m)[2];
...
static inline void sum_vec3(const vec3 *u, const vec3 *v, vec3 *w)
{
	(*w)[0] = (*u)[0] + (*v)[0];
	(*w)[1] = (*u)[1] + (*v)[1];
	(*w)[2] = (*u)[2] + (*v)[2];
...
static inline void sum_vec4(const vec4 *u, const vec4 *v, vec4 *w)
{
	(*w)[0] = (*u)[0] + (*v)[0];
	(*w)[1] = (*u)[1] + (*v)[1];
	(*w)[2] = (*u)[2] + (*v)[2];
...
static inline void sum_mat3(const mat3 *m, const mat3 *n, mat3 *l)
{
	(*l)[0] = (*m)[0] + (*n)[0];
	(*l)[1] = (*m)[1] + (*n)[1];
	(*l)[2] = (*m)[2] + (*n)[2];
...
static inline void sum_mat4(const mat4 *m, const mat4 *n, mat4 *l)
{
	(*l)[0] = (*m)[0] + (*n)[0];
	(*l)[1] = (*m)[1] + (*n)[1];
	(*l)[2] = (*m)[2] + (*n)[2];
...
static inline void product_mat3(const mat3 *m, const mat3 *n, mat3 *l)
{
	mat3 k;
...
static inline void product_mat3_mat4(const mat3 *m, const mat4 *n, mat4 *l)
{
	mat4 k;
...
static inline void product_mat4(const mat4 *m, const mat4 *n, mat4 *l)
{
	mat4 k;
...
static inline void product_mat3_vec3(const mat3 *m, const vec3 *u, vec3 *v)
{
...
static inline void product_mat4_vec4(const mat4 *m, const vec4 *u, vec4 *v)
{
...
static inline void product_mat4_vec3(const mat4 *m, const vec3 *u, vec3 *v)
{
...
static inline void product_c_vec3(const scalar *c, const vec3 *u, vec3 *v)
{
	(*v)[0] = *c * (*u)[0];
	(*v)[1] = *c * (*u)[1];
	(*v)[2] = *c * (*u)[2];
...
static inline void product_c_vec4(const scalar *c, const vec4 *u, vec4 *v)
{
	(*v)[0] = *c * (*u)[0];
	(*v)[1] = *c * (*u)[1];
	(*v)[2] = *c * (*u)[2];
...
static inline void product_c_mat3(const scalar *c, const mat3 *m, mat3 *n)
{
	(*n)[0] = *c * (*m)[0];
	(*n)[1] = *c * (*m)[1];
	(*n)[2] = *c * (*m)[2];
...
static inline void product_c_mat4(const scalar *c, const mat4 *m, mat4 *n)
{
	(*n)[0] = *c * (*m)[0];
	(*n)[1] = *c * (*m)[1];
	(*n)[2] = *c * (*m)[2];
...
static inline void product_vec3(const vec3 *u, const vec3 *v, scalar *c)
{
	*c = (*u)[0] * (*v)[0] + (*u)[1] * (*v)[1] + (*u)[2] * (*v)[2];
}

static inline void product_vec4(const vec4 *u, const vec4 *v, scalar *c)
{
...
static inline scalar det_mat3(const mat3 *m)
{
...
static inline scalar tr_mat3(const mat3 *m)
{
	return  (*m)[0] + (*m)[4] + (*m)[8];
}

static inline scalar tr_mat4(const mat4 *m)
{
...
static inline void transpose_mat3(const mat3 *m, mat3 *n)
{
	mat3 l;
...
static inline void transpose_mat4(const mat4 *m, mat4 *n)
{
	mat4 l;
